 ...
 *
 * @version $Id: report.php,v 1.4.2.5 2011/08/17 01:09:22 bdaloukas Exp $
 * @author bdaloukas.
...
class game_report extends game_default_report {
    ...
    function display($game, $cm, $course) {
        ...
        $tableheaders = array(NULL, '', get_string('fullname'), get_string('startedon', 'game'), get_string('timecompleted','game'), get_string('timetaken', 'game'));
        ...
        if (!$download) {
            ...
            $sheettitle = get_string('overview','game');
            ...
            $headers = array(get_string('fullname'), get_string('startedon', 'game'), get_string('timecompleted', 'game'), get_string('timetaken', 'game'));
            ...
            $headers = get_string('fullname')."\t".get_string('startedon', 'game')."\t".get_string('timecompleted', 'game')."\t".get_string('timetaken', 'game');
        ...
        if(!empty($attempts) || !empty($noattempts)) {
            ...
            if (!$download) {
                ...
                if (!empty($attempts)) {
                    ...
                    echo "</td>\n";
                    echo "<td>";
                    helpbutton('overviewdownload', get_string('overviewdownload', 'quiz'), 'quiz');
                    echo "</td>\n";
                    echo '</tr></table>';
                }
            } else if ($download == 'Excel' or $download == 'ODS') {
