...
function xmldb_game_upgrade($oldversion) {
	...
	if ($oldversion < ($ver = 2017061604)) {
		$table = new xmldb_table('game_snakes_database');
		$field = new xmldb_field('usedcols', XMLDB_TYPE_INTEGER, '2', XMLDB_UNSIGNED, null, null, '0', 'id');
		if (!$dbman->field_exists($table, $field)) {
			$dbman->add_field($table, $field);
		}

		$field = new xmldb_field('cols', XMLDB_TYPE_INTEGER, '2', XMLDB_UNSIGNED, null, null, '0', 'id');
		if ($dbman->field_exists($table, $field)) {
	...
	if ($oldversion < ($ver = 2017061604)) {
		$table = new xmldb_table('game_snakes_database');
		$field = new xmldb_field('usedrows', XMLDB_TYPE_INTEGER, '2', XMLDB_UNSIGNED, null, null, '0', 'id');
		if (!$dbman->field_exists($table, $field)) {
			$dbman->add_field($table, $field);
		}

		$field = new xmldb_field('rows', XMLDB_TYPE_INTEGER, '2', XMLDB_UNSIGNED, null, null, '0', 'id');
		if ($dbman->field_exists($table, $field)) {
